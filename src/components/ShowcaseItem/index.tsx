...
const showcaseItemStyles = tv({
  ...
  slots: {
    ...
    button: 'block bg-gray-900 text-white w-full md:max-w-sm h-16 sm:h-20 uppercase tracking-wide font-medium text-2xl sm:text-4xl mt-8 hover:bg-primary-600 transition-all hover:shadow-lg',
    h1: 'text-[74px] sm:text-[90px] whitespace-pre lg:text-[120px] font-semibold font-roboto uppercase text-gray-900 leading-none'
  },
  variants: {
    type: {
      tlou: {
